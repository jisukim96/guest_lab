...
<link href="guestlab.css" rel="stylesheet" type="text/css">
...
<P>
<P align=center><FONT color=#0000ff face=굴림 size=3><STRONG>회원 정보</STRONG></FONT></P> 
<P>
<CENTER>
...
//		if(true) return;		//프로그램 멈춤
  ...
  <tr>
  	...
  	<td><a href="guestlab_read.jsp?id=<%=idx.elementAt(j)%>&page=<%=where%>"> <%= phone.elementAt(j)%> </a></td>
...
<!-- JSP 코드 블락 : DB의 레코드를 가져와서 루프 (끝)-->
 ...
 <!--  페이징 출력 부분 : [처음][이전] 1 2 3 4 5 [다음][끝] -->
...
<TABLE border=0 width=600 cellpadding=0 cellspacing=0>
 <TR>
  <TD align=right width="241"> 
   <SELECT name=stype >
    <OPTION value=1 >이름
    <OPTION value=2 >휴대폰번호
    <OPTION value=3 >주소
    <OPTION value=4 >이름+휴대폰번호
    <OPTION value=5 >이름+주소
    <OPTION value=6 >휴대폰번호+주소
    <OPTION value=7 >이름+휴대폰번호+주소
   </SELECT>
  </TD>
