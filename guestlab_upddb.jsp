...
<% 
	...
	//rs는 DB에서 password 필드의 값을 가져와서 폼에서 넘겨받은 password와 비교 후 같으면 update
	if (!(rs.next())){	//rs의 값이 존재하지 않을 떄
		...
		out.println("<p/>"+ pwd+"<p/>");
		out.println(pw+"<p/>");
		out.println(pwd.equals(pw));	 	//DB의 값과 form에서 받은 값이 같으면 true, 다르면 false
		*/
	/* 	if (true) return; */
